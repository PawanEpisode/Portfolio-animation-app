...
import Parallax from "./HeroParallax";
...
const PortfolioLandingPage = () => {
    ...
    const features = [
        ...
        description: "Creating fluid layouts for all devices",
        icon: "📱",
        },
        {
        title: "Modern Frameworks",
        description: "Expertise in React, Next.js, and more",
        icon: "⚛️",
        },
        {
        title: "Performance Optimization",
        description: "Building fast and efficient web apps",
        icon: "⚡",
        },
    ];
